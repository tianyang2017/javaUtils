...
public class ChartGraphics {
    //生成图片文件
    public static void graphicsGeneration( String imgurl,String outputfileLocation) {
        int H_title = 30;     //头部高度
    ...
    public static void main(String[] args) {
    	...
    	String outputfileLocation="D:\\workspace\\zhongzhi\\javaUtils\\test\\2.jpg";
        ChartGraphics cg = new ChartGraphics();
        try {
            cg.graphicsGeneration(imgurl,outputfileLocation);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
